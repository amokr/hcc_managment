...
<html>
<title>Student_edit_profile </title>
...
<div id="cid_5" class="form-input jf-required">
	...
	<option value="AB-"> AB- </option>
     ...
     <li class="form-line" data-type="control_textbox" id="id_3">
      ...
      <label class="form-label form-label-left" id="label_3" for="input_3"> Weight
      ...
      <input type="number" id="input_3" name="wgh" data-type="input-textbox"  class="form-textbox validate" size="20" value="" tabindex="-1" data-component="textbox"  />
 
           <label class="form-sub-label" for="input_3" style="min-height:13px;">
...
<li class="form-line" data-type="control_textbox" id="id_3">
      ...
      <label class="form-label form-label-left" id="label_3" for="input_3"> Age
      ...
      <input type="number" id="input_3" name="age" data-type="input-textbox" class="form-textbox validate" size="20" value="" tabindex="-1" data-component="textbox"  />
